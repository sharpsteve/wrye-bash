...
class ImportFaceDialog(balt.Dialog):
    ...
    def __init__(self, parent, title, fileInfo, faces):
        ...
        self.nameCheck = checkBox(self, _('Name'), checked=fi_flgs.name)
        self.raceCheck = checkBox(self, _('Race'), checked=fi_flgs.race)
        self.genderCheck = checkBox(self, _('Gender'), checked=fi_flgs.gender)
        self.statsCheck = checkBox(self, _('Stats'), checked=fi_flgs.stats)
        self.classCheck = checkBox(self, _('Class'), checked=fi_flgs.iclass)
