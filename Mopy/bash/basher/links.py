...
def InitStatusBar():
    ...
    BashStatusBar.buttons.append( # Game
        Game_Button(
            ...
            imageList('%s%%s.png' % bush.game.fsName.lower()),
            ' '.join((_("Launch"),bush.game.displayName)),
            ' '.join((_("Launch"),bush.game.displayName,'%(version)s'))))
    BashStatusBar.buttons.append( #TESCS/CreationKit
        TESCS_Button(
            bass.dirs['app'].join(bush.game.cs.exe),
            imageList(bush.game.cs.image_name),
            ' '.join((_("Launch"),bush.game.cs.cs_abbrev)),
            ' '.join((_("Launch"),bush.game.cs.cs_abbrev,'%(version)s')),
    ...
    BashStatusBar.buttons.append( #EnderalEdit
        App_Tes4View((bass.tooldirs['EnderalEditPath'], '-Enderal -edit'),
                     imageList('tools/tes4edit%s.png'),
                     _("Launch EnderalEdit"),
                     uid='EnderalEdit'))
    ...
    BashStatusBar.buttons.append( #Fo3Edit
        App_Tes4View((bass.tooldirs['Fo3EditPath'],'-FO3 -edit'),
                     imageList('tools/tes4edit%s.png'),
                     _("Launch FO3Edit"),
                     uid='FO3Edit'))
    BashStatusBar.buttons.append( #FnvEdit
        App_Tes4View((bass.tooldirs['FnvEditPath'],'-FNV -edit'),
                     imageList('tools/tes4edit%s.png'),
                     _("Launch FNVEdit"),
                     uid='FNVEdit'))
    ...
    badIcons = [Image(bass.dirs['images'].join('error_cross_16.png'))] * 3
...
def InitInstallerLinks():
    ...
    if True:  #--Package Menu
        packageMenu = MenuLink(_("Package.."))
...
def InitModLinks():
    ...
    if True: #--Load
        loadMenu = MenuLink(_('Load Order'))
