...
class MelEmbeddedScript(MelSequential):
    ...
    def __init__(self, with_script_vars=False):
        seq_elements = [
            MelUnion({
                b'SCHR': MelStruct(b'SCHR', u'4s4I', u'unused1',
...
class MreAppa(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelIcon(),
        MelScript(),
        MelStruct(b'DATA', '=BIff', 'apparatus', 'value',
                  'weight', 'quality'),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreCrea(MreActorBase):
    ...
    melSet = MelSet(
        ...
        MelScript(),
        MelItems(),
        MelStruct(b'AIDT', '=4BIbB2s', 'aggression', 'confidence',
                  'energyLevel', 'responsibility', (aiService, u'services'),
                  'trainSkill', 'trainLevel', ('unused1', null2)),
...
class MreFact(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelFloat(b'CNAM', u'crime_gold_multiplier'), #:def AssortedTweak_FactioncrimeGoldMultiplier
        MelGroups(u'ranks',
...
class MreLigh(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelTruncatedStruct(b'DATA', 'iI3BsIffIf', 'duration', 'radius', 'red',
                           'green', 'blue', 'unused1', (_flags, u'flags'),
