...
from ...brec import MelRecord, MelObject, MelGroups, MelStruct, FID, \
    ...
    MelUInt16, MelUInt32, MelActionFlags, MelCounter, \
...
class MreCell(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelSkipInterior(MelFloat(b'XCLW', u'waterHeight', # -2147483649 FIXME test
                                    )),
...
class MreRace(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelBase(b'MNAM', u'male_marker'), # required
        ...
        MelBase(b'FNAM', u'female_marker'), # required
        ...
        MelAttacks(), MelBase(b'NAM1', u'body_data_marker'), # required
        MelBase(b'MNAM', u'male_data_marker'), # required
        MelGroups(u'male_body_data',
            MelUInt32(b'INDX', u'body_part_index'), # required
            MelModel(),
        ), MelBase(b'FNAM', u'female_data_marker'), # required
        ...
        MelBase(b'NAM3', u'behavior_graph_marker'), # required
        MelBase(b'MNAM', u'male_graph_marker'), # required
        MelModel(u'male_behavior_graph'),
        MelBase(b'FNAM', u'female_graph_marker'), # required
...
class MreSopm(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelStruct(b'ONAM', '24B', u'ch0_l', u'ch0_r', u'ch0_c', u'ch0_lFE',
            ...
            u'ch2_bL', u'ch2_bR'),
        MelStruct(b'ANAM', u'4s2f5B3s', u'unknown2', u'minDistance',
...
class MreWeap(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelStruct(b'DNAM', u'B3s2fH2sf4s4B2f2I5f12si8si4sf', u'animationType',
                  ...
                  (u'dnamUnk6', null4 * 2), u'resist', u'dnamUnk7',
                  u'stagger'),
        MelIsSSE(
