...
class MelEmbeddedScript(MelSequential):
    ...
    def __init__(self):
        super(MelEmbeddedScript, self).__init__(
            MelStruct(b'SCHR', u'4s3I2H', u'unused1', u'num_refs',
...
class MreCell(MelRecord):
    ...
    melSet = MelSet(
        ...
        # last mod.
        MelFloat(b'XCLW', u'waterHeight' #:def, -2147483649
                    ),
...
class MreEfsh(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelTruncatedStruct(b'DATA',
            ...
            u'unused1', u'memSBlend', u'memBlendOp',
            u'memZFunc', u'fillRed', u'fillGreen', u'fillBlue',
            ...
            u'partBlendOp', u'partZFunc', u'partDBlend',
            ...
            u'key1Red', u'key1Green', u'key1Blue',
            u'unused4', u'key2Red', u'key2Green',
            u'key2Blue', u'unused5', u'key3Red',
            u'key3Green', u'key3Blue', u'unused6',
            ...
            u'explosionWindSpeed', u'textureCountU',
            u'textureCountV', (u'addonModelsFadeInTime', 1.0),
...
class MreLigh(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelStruct(b'DATA','iI3BsI2fIf','duration','radius','red','green','blue',
                  ...
                  'weight'),
        MelFloat(b'FNAM', u'fade'), #:def AssortedTweak_LightFadeValueFix
        MelFid(b'SNAM','sound'),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreNpc(MreActor):
    ...
    melSet = MelSet(
        ...
        MelNpcDnam(b'DNAM', u'=28B', (u'skillValues', [0] * 14),
                   (u'skillOffsets', [0] * 14)),
        MelFid(b'HNAM','hair'),
        MelFloat(b'LNAM', u'hairLength'),  #:def , for race patcher
...
class MrePerk(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelIcons(),
        MelConditions(),
        MelTruncatedStruct(b'DATA', '5B', 'trait', 'minLevel', 'ranks',
                           'playable', 'hidden', old_versions={'4B'}),
        MelGroups('effects',
...
class MreWeap(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelTruncatedStruct(b'DNAM', 'I2f4B5fI4B2f2I11fiI2fi3f',
            ...
            (_dflags1,'dnamFlags1'),('gripAnimation',255),'ammoUse',
            ...
            'minRange','maxRange','onHit',(_dflags2,'dnamFlags2'),
        ...
        MelOptStruct(b'CRDT','H2sfB3sI','criticalDamage','weapCrdt1',
